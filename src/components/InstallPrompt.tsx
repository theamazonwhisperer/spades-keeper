...
export default function InstallPrompt() {
  ...
  useEffect(() => {
    ...
    // Do NOT clear the global here — keep it alive so remounts (Suspense, HMR,
    // navigation) can still find it. We only clear it after prompt() is called.
  ...
  const handleInstall = async () => {
    ...
    // Now that the prompt has been shown, clear the global so it isn't reused.
